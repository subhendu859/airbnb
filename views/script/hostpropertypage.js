const getpropertypage = async () => {
    try {
        ...
        const review = await fetch(`http://localhost:3000/propertyreview`)
        const rating = await fetch(`http://localhost:3000/propertyrating`)
        ...
        bigImg.innerHTML = `<img src="../images/${getData.gallery[0][0]}"
                            alt="Gallery image 1" class="ecommerce-gallery-main-img active" />`;
        smallImg.innerHTML = ` <div class="col-6 top">
                            <img src="../images/${getData.gallery[0][1]}"
                            alt="Gallery image 1"/>
                            </div>
                            <div class="col-6 top">
                                <img src="../images/${getData.gallery[0][2]}"
                                    alt="Gallery image 2"/>
                            </div>
                            <div class="col-6 bottom">
                                <img src="../images/${getData.gallery[0][3]}"
                                    alt="Gallery image 3" />
                            </div>
                            <div class="col-6 bottom">
                                <img src="../images/${getData.gallery[0][4]}"
                                    alt="Gallery image 4"/>
                            </div>`;
